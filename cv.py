from flask import Flask, request, render_template #Importacion de Flask para API´S
import math
...
@app.route("/resultado")
def resultado():
    valor = request.args.get('maxcarga')
    valor = int(valor)
    ...
    return render_template("resultado.html",resultado=valor,mejor_ruta=ruta)
